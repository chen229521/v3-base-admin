...
export const locales = {
    'zh-cn': {
        ...
        gitCommitVerify: `${bgRed(' 错误 ')} ${red(
            'git 提交信息必须符合 Conventional Commits 标准!'
        )}\n\n${green(
    ...
    'en-us': {
        gitCommitMessages: {
            ...
            description: `Please enter a description (add prefix ${yellow(
                '!'
        ...
        gitCommitVerify: `${bgRed(' ERROR ')} ${red(
